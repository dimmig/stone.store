...
import { Heart, Minus, Plus, ShoppingBag, ChevronRight, Star, Check } from 'lucide-react';
            ...
            >
              ...
              >
                <motion.button
                  ...
                  className="flex h-12 flex-1 items-center justify-center gap-2 rounded-xl bg-black px-6 text-sm font-medium text-white transition-opacity hover:opacity-90"
                >
