  ...
  return (
    <div className={`h-[100%] w-[100%] transition all duration-300`} id="main">
      ...
      <div className="main-info flex flex-row justify-around mt-32 pb-16">
              ...
              <CardContent className="p-0">
                <div className="relative w-full h-full">
                  ...
                  <Image
                    ...
                    onLoad={() =>
                      handleImageLoad(`${currentItem.images[0]}-${color}`)
                    }
                  />
                </div>
              </CardContent>
        ...
        <div
          className="flex justify-center items-center relative p-10 pr-20 pl-48 rounded-sm pt-0"
          id="img-bg"
        >
      ...
      <div className="mr-20">
        ...
        <div>
          <div
            className="mt-10 mb-4 rounded-sm bg-gray-100 p-5"
            id="description-bg"
          >
        ...
        <div className="relative flex flex-row flex-between gap-5">
          <Button className="w-[200px] font-bold text-3xl mt-5 rounded-sm flex-center bg-black">
            Add to Cart
          </Button>
          <Badge
            className={`${
              currentItem.discount ? "" : "w-[200px]"
            } px-10 font-bold  text-3xl mt-5 rounded-sm flex-center`}
            variant="secondary"
          >
